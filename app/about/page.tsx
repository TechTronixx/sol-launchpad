      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col items-center mb-16 text-center">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-3 py-1 mb-6 rounded-full bg-secondary/50 border border-border"
          >
          ...
          <motion.h1
            ...
            className="text-4xl md:text-6xl lg:text-7xl font-bold font-clash text-foreground tracking-tight mb-6"
          >
            REVOLUTIONIZING <br />
        ...
        >
          ...
          <div className="bg-card/40 backdrop-blur-md border border-border p-8 md:p-12 relative overflow-hidden group">
            ...
            <div className="relative z-10 space-y-8">
              ...
              <div className="grid md:grid-cols-2 gap-8 py-8">
                <div className="space-y-4">
                  <h3 className="text-xl font-clash font-semibold text-foreground flex items-center gap-2">
                    <Icon
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-sm text-muted-foreground font-mono leading-relaxed">
                    Our flagship platform offers automated reward systems,
